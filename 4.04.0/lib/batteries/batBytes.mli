...
# 423 "src/batBytes.mliv"

external unsafe_set : t -> int -> char -> unit = "%bytes_unsafe_set"
# 426 "src/batBytes.mliv"

external unsafe_blit :  t -> int -> t -> int -> int -> unit = "caml_blit_bytes" "noalloc"
# 429 "src/batBytes.mliv"

external unsafe_fill:  t -> int -> int -> char -> unit = "caml_fill_bytes" "noalloc"
