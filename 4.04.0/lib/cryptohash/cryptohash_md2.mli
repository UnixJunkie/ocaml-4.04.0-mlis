...
(** Md2.unsafe_update_substring ctx s ~pos ~len updates the context
...
(** Md2.update_substring ctx s ofs len updates the context with the
...
(** Md2.substring s ofs len returns the digest of the substring of
