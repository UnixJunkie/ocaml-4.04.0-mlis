...
(** Sha384.unsafe_update_substring ctx s ~pos ~len updates the context
...
(** Sha384.update_substring ctx s ofs len updates the context with the
...
(** Sha384.update_string ctx s updates the context with s. *)
...
(** Sha384.substring s ofs len returns the digest of the substring of
