...
(** Ripemd160.unsafe_update_substring ctx s ~pos ~len updates the context
...
(** Ripemd160.update_substring ctx s ofs len updates the context with the
...
(** Ripemd160.update_string ctx s updates the context with s. *)
...
(** Ripemd160.substring s ofs len returns the digest of the substring of
