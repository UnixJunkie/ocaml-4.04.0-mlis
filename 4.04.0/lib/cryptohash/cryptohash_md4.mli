...
(** Md4.unsafe_update_substring ctx s ~pos ~len updates the context
...
(** Md4.update_substring ctx s ofs len updates the context with the
...
(** Md4.update_string ctx s updates the context with s. *)
...
(** Md4.substring s ofs len returns the digest of the substring of
