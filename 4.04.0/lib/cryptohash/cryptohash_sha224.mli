...
(** Sha224.unsafe_update_substring ctx s ~pos ~len updates the context
...
(** Sha224.update_substring ctx s ofs len updates the context with the
...
(** Sha224.update_string ctx s updates the context with s. *)
...
(** Sha224.substring s ofs len returns the digest of the substring of
