...
(** Tiger.unsafe_update_substring ctx s ~pos ~len updates the context
...
(** Tiger.update_substring ctx s ofs len updates the context with the
...
(** Tiger.substring s ofs len returns the digest of the substring of
