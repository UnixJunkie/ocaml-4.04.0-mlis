...
(** Whirlpool.unsafe_update_substring ctx s ~pos ~len updates the context
...
(** Whirlpool.update_substring ctx s ofs len updates the context with the
...
(** Whirlpool.update_string ctx s updates the context with s. *)
...
(** Whirlpool.substring s ofs len returns the digest of the substring of
