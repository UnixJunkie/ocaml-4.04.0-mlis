...
Refering to the stdlib directly is discouraged by Base. You should either
use the equivalent functionality offered by Base, or if you really want to
refer to the stdlib, use Caml.Printexc instead"]
...
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Caml.succ] instead"]

external pred : int -> int = "%predint"
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Caml.pred] instead"]
...
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Caml.( mod )] instead"]
...
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Caml.max_int] instead"]

val min_int : int
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Caml.min_int] instead"]
...
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Caml.copysign] instead"]

external mod_float : float -> float -> float = "caml_fmod_float" "fmod" [@@unboxed] [@@noalloc]
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Caml.mod_float] instead"]

external frexp : float -> float * int = "caml_frexp_float"
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Caml.frexp] instead"]

external ldexp : (float [@unboxed]) -> (int [@untagged]) -> (float [@unboxed]) = "caml_ldexp_float" "caml_ldexp_float_unboxed" [@@noalloc]
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Caml.ldexp] instead"]

external modf : float -> float * float = "caml_modf_float"
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Caml.modf] instead"]

external float : int -> float = "%floatofint"
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Caml.float] instead"]

external float_of_int : int -> float = "%floatofint"
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Caml.float_of_int] instead"]

external truncate : float -> int = "%intoffloat"
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Caml.truncate] instead"]

external int_of_float : float -> int = "%intoffloat"
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Caml.int_of_float] instead"]

val infinity : float
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Caml.infinity] instead"]

val neg_infinity : float
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Caml.neg_infinity] instead"]

val nan : float
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Caml.nan] instead"]

val max_float : float
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Caml.max_float] instead"]

val min_float : float
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Caml.min_float] instead"]

val epsilon_float : float
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Caml.epsilon_float] instead"]
...
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Caml.classify_float] instead"]
...
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Caml.int_of_char] instead"]

val char_of_int : int -> char
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Caml.char_of_int] instead"]
...
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Caml.string_of_bool] instead"]

val bool_of_string : string -> bool
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Caml.bool_of_string] instead"]

val string_of_int : int -> string
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Caml.string_of_int] instead"]

external int_of_string : string -> int = "caml_int_of_string"
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Caml.int_of_string] instead"]

val string_of_float : float -> string
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Caml.string_of_float] instead"]

external float_of_string : string -> float = "caml_float_of_string"
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Caml.float_of_string] instead"]
...
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Caml.print_bytes] instead"]
...
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Caml.prerr_bytes] instead"]
...
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Caml.output_bytes] instead"]
...
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Caml.incr] instead"]

external decr : int ref -> unit = "%decr"
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Caml.decr] instead"]
