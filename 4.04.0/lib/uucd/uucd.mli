...
(** Unicode character database decoder.
    ...
    Unicode 9.0.0. Subsequent versions may be decoded as
    ...
    {e Release v4.0.0 — Unicode version 9.0.0 —
       {{:http://erratique.ch/software/uucd }homepage}}
    {3 References}
    {ul
...
(** {1:basics Basics}
    ...
    The database and subsets of it for Unicode 9.0.0 are
    available
    {{:http://www.unicode.org/Public/9.0.0/ucdxml/}here}.
